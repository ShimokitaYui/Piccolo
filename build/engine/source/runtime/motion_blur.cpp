...
namespace Pilot
{
    ...
    { 
        ...
        VkDescriptorSetLayoutBinding& post_process_global_combinded_image_sampler_binding =
            post_process_global_layout_bindings[0];
        post_process_global_combinded_image_sampler_binding.binding         = 0;
        post_process_global_combinded_image_sampler_binding.descriptorType  = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
        post_process_global_combinded_image_sampler_binding.descriptorCount = 1;
        post_process_global_combinded_image_sampler_binding.stageFlags      = VK_SHADER_STAGE_FRAGMENT_BIT;
        ...
        post_process_global_layout_input_attachment_binding.binding         = 3;
    ...
    { 
        ...
        VkShaderModule motion_blur_shader_module;
        ...
        frag_pipeline_shader_stage_create_info.module = motion_blur_shader_module;
        ...
        pipelineInfo.subpass             = _main_camera_subpass_motion_blur;
        ...
        VkBuffer    matrix_ubo_buffer)
    {
        ...
        post_process_descriptor_depth_attachment_write_info.dstBinding      = 0;
